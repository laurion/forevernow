...
;(function(root, factory) {
  ...
  function SHGMoney(platform, config) {
    ...
    this.config = config || defaultConfig[platform] || defaultConfig["default"]
  }
  ...
  SHGMoney.prototype.formatMoney = function(cents, config) {
    ...
    var formatter = formatters[self.platform] || formatters["default"]
...
;(function($) {
  ...
  window.addEventListener("load", initializeInteractionObserver)
...
;(function($) {
  ...
  function initializeImages () {
    if (window.SHOGUN_IMAGE_ELEMENTS && window.SHOGUN_IMAGE_ELEMENTS.length) {
      window.SHOGUN_IMAGE_ELEMENTS.forEach(function (image) {
        var uuid = image.uuid
        image.ref = document.querySelector("#" + uuid + " .shogun-image-container .shogun-image")
...
;(function($) {
  ...
  $(function() {
    window.SHOGUN_SLIDERS.forEach(function(slider, index) {
      if (slider.autoplay) {
        window.SHOGUN_SLIDERS[index].interval = createInterval(slider)
        $(slider.id)
          .find("> .shg-sld-content > .shg-sld-nav-button, > .shg-sld-dots > .shg-sld-dot")
          .click(function() {
